...
class AdminController
{
    ...
    public function editStream(Request $request, Response $response, array $args): Response
    {
        ...
        $data = [
            ...
            "alertBoxWidgetPictureUrl" => $alertBoxWidget ? $this->fileManager->getPictureUrl($alertBoxWidget->image) : null,
            "alertBoxWidgetSoundUrl" => $alertBoxWidget ? $this->fileManager->getSoundUrl($alertBoxWidget->sound) : null,
