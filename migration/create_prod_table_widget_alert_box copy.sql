CREATE TABLE prod_widget_alert_box (
    ...
    CONSTRAINT fk_prod_charity_stream_guid_alert_box FOREIGN KEY (charity_stream_guid) REFERENCES prod_charity_stream(guid)  -- Clé étrangère renommée pour éviter le conflit
);

CREATE INDEX idx_charity_stream_guid ON prod_widget_alert_box(charity_stream_guid);
CREATE INDEX idx_alert_duration ON prod_widget_alert_box(alert_duration);
