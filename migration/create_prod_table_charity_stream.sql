CREATE TABLE prod_charity_stream (
    ...
    form_slug VARCHAR(255) NOT NULL,  -- Slug du formulaire,
    organization_slug VARCHAR(255) NOT NULL,  -- Identifiant de l'association,
...
CREATE INDEX idx_owner_email ON prod_charity_stream(owner_email);
CREATE INDEX idx_form_id ON prod_charity_stream(form_id);
CREATE INDEX idx_state ON prod_charity_stream(state);
