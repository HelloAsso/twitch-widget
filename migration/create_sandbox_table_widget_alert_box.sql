CREATE TABLE sandbox_widget_alert_box (
    ...
    CONSTRAINT fk_sandbox_charity_stream_guid_alert_box FOREIGN KEY (charity_stream_guid) REFERENCES sandbox_charity_stream(guid)  -- Clé étrangère renommée pour éviter le conflit
);

CREATE INDEX idx_charity_stream_guid ON sandbox_widget_alert_box(charity_stream_guid);
CREATE INDEX idx_alert_duration ON sandbox_widget_alert_box(alert_duration);
