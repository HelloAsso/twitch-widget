CREATE TABLE sandbox_widget_donation_goal_bar (
	...
	CONSTRAINT fk_sandbox_charity_stream_guid_donation_goal_bar FOREIGN KEY (charity_stream_guid) REFERENCES sandbox_charity_stream(guid)
);

CREATE INDEX idx_charity_stream_id ON sandbox_widget_donation_goal_bar(charity_stream_guid);
CREATE INDEX idx_goal ON sandbox_widget_donation_goal_bar(goal);
