CREATE TABLE sandbox_access_token_partner_organization (
...
CREATE INDEX idx_access_token ON sandbox_access_token_partner_organization(access_token);

-- Index sur refresh_token pour les vérifications rapides lors des rotations de tokens
CREATE INDEX idx_refresh_token ON sandbox_access_token_partner_organization(refresh_token);
